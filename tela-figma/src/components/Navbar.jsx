            ...
            <div className="flex h-11 justify-between">
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current
                          ? "inline-flex items-center border-b-2 border-complement px-1 pt-1 text-sm font-medium text-white"
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <button
                    type="button"
                    className="relative inline-flex items-center rounded-xl border border-transparent bg-button px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-900 focus:ring-offset-2 focus:ring-offset-gray-800"
                  >
                    <PlusIcon className="h-5" aria-hidden="true" />
                  </button>
                </div>
